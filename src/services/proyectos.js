...
export async function getProyectsForAdmin() {
  const url = 'https://controlback.onrender.com/api/proyectos/findAllConCompra';
...
//export async function getProyectsForAdmin() {
//   const url = 'https://controlback.onrender.com/api/proyectos/allProyects';
//   const response = await fetch(url, {
//     method: 'GET', // *GET, POST, PUT, DELETE, etc.
//     mode: 'cors', // no-cors, *cors, same-origin
//     cache: 'no-cache', // *default, no-cache, reload, force-cache
...
export async function getProyecto(username) {
  const url = `https://controlback.onrender.com/api/proyectos/${username}`;
  const response = await fetch(url, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    mode: 'cors', // no-cors, *cors, same-origin
...
//   const url = 'https://controlback.onrender.com/api/proyectos';
//   const response = await fetch(url, {
...
export async function getUserByProyect(idProyecto) {
  const url = `https://controlback.onrender.com/api/usuariosproyectos/getUsuariosIdProyecto/${idProyecto}`;
  const response = await fetch(url, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    mode: 'cors', // no-cors, *cors, same-origin
    cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
...
export async function getProyectoById(idProyecto) {
  const url = `https://controlback.onrender.com/api/proyectos/findByName/${idProyecto}`;
  const response = await fetch(url, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    mode: 'cors', // no-cors, *cors, same-origin
    cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
...
// export async function getProyectoById(idProyecto) {
//   const url = 'https://controlback.onrender.com/api/proyectos/findByName';
//   const response = await fetch(url, {
//     method: 'POST', // *GET, POST, PUT, DELETE, etc.
//     mode: 'cors', // no-cors, *cors, same-origin
//     cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
...
export async function createProyecto(body) {
  const url = 'https://controlback.onrender.com/api/proyectos/create';
  const response = await fetch(url, {
    method: 'POST', // *GET, POST, PUT, DELETE, etc.
    mode: 'cors', // no-cors, *cors, same-origin
    cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
